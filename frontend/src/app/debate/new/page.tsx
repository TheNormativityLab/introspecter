...
import { Users, MessageSquare, FileText, Settings, Brain, User, PlayCircle, Clock, CheckCircle, Plus, Trash2, ArrowLeft, AlertTriangle, Terminal } from 'lucide-react';
        ...
        <div className="header-content">
          ...
          <div className="header-main">
            <div>
              ...
              <p className="header-subtitle">Set up a new debate experiment with AI agents or human participants</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="form-card">
          ...
          <div className="section">
            ...
            <div className="form-grid">
              ...
              <div className="input-row">
                <div className="input-group">
                  ...
                  <input
                    ...
                    className={`modern-input ${isQuestionsExceeded() ? 'error' : ''}`}
                  />
                  <p className="input-help">Number of questions to use from each selected dataset</p>
                  {isQuestionsExceeded() && (
                ...
                <div className="input-group">
                  ...
                  <input
                    ...
                    className={`modern-input ${isRoundsExceeded() ? 'error' : ''}`}
                  />
                  {isRoundsExceeded() && (
                    <div className="error-message">
                      <AlertTriangle className="w-4 h-4" />
              ...
              <div className="input-group">
                ...
                <p className="input-help">Select one or more seeds (1-4) for reproducible random sampling</p>
              </div>
            </div>
          </div>
          ...
          <div className="section">
            <div className="section-header">
              ...
              <div className="section-header-right">
                <span className="agent-count">{getEnabledAgents().length} agents enabled</span>
            ...
            <div className="agents-list">
              {formData.agents.map((agent, index) => (
                <div key={agent.id} className={`agent-card ${agent.enabled ? 'enabled' : 'disabled'}`}>
          ...
          <div className="section">
            ...
            <div className="dataset-section">
              <label className="input-label">Choose Datasets (can select multiple)</label>
              <p className="input-help">Select one or more datasets. Each dataset will contribute {formData.numQuestions} questions to the debate.</p>
              
              <div className="dataset-list">
                {availableDatasets.map(dataset => (
                  <label key={dataset.value} className={`dataset-item ${formData.selectedDatasets.includes(dataset.value) ? 'selected' : ''}`}>
                    <input
                      type="checkbox"
                    ...
                    <div className="dataset-content">
                      ...
                      {dataset.value === 'custom' && formData.customQuestions.filter(q => q.trim()).length > 0 && (
                        <span className="dataset-meta">{formData.customQuestions.filter(q => q.trim()).length} custom questions</span>
                      )}
                    </div>
                  </label>
                ))}
            ...
            {showCustomQuestions && formData.selectedDatasets.includes('custom') && (
              <div className="custom-questions-section">
                <div className="custom-questions-header">
                  ...
                  <button onClick={addCustomQuestion} className="add-question-button">
                    <Plus className="w-4 h-4" />
                    Add Question
                  </button>
                </div>
                <p className="input-help">Add your own custom questions in addition to the selected datasets.</p>
            ...
            <div className="summary-grid">
              <div className="summary-column">
                ...
                <ul className="summary-list">
                  ...
                  <li><strong>Questions:</strong> {getTotalQuestions()} (applied to each dataset)</li>
